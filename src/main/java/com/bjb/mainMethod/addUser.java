...
public class addUser {
    ...
    private static void add(String environment) {
        SqlSession sqlSession = MybatisUtils.getSqlSession(environment);
        UserDao userDao = sqlSession.getMapper(UserDao.class);
        Integer provinceCode = chooseProvinceCode();
        User user = new User();
        ...
        user.setCityCode(getAreaBySuper(user.getProvinceCode(), environment).getAreaCode());
        user.setCountyCode(getAreaBySuper(user.getCityCode(), environment).getAreaCode());
        user.setProvinceName(getAreaByCode(user.getProvinceCode(), environment).getAreaName());
        user.setCityName(getAreaBySuper(user.getProvinceCode(), environment).getAreaName());
        user.setCountyName(getAreaBySuper(user.getCityCode(), environment).getAreaName());
    ...
    private static Integer chooseProvinceCode() {
        int[] provinceCodeArr = {52, 15, 46};
        return provinceCodeArr[new Random().nextInt(provinceCodeArr.length)];
    }
    ...
    private static Area getAreaBySuper(Integer areaCode, String environment) {
        SqlSession sqlSession = MybatisUtils.getSqlSession(environment);
    ...
    private static Area getAreaByCode(Integer areaCode, String environment) {
        SqlSession sqlSession = MybatisUtils.getSqlSession(environment);
        AreaDao areaDao = sqlSession.getMapper(AreaDao.class);
    ...
    private static String getGivenName(String gender) {
        ...
        String[] maleArr = {
            "力", "明", "永", "健", "世", "广", "志", "义", "兴", "良", "海", "山", "仁波","宁","贵","福", "生", "龙", "元", "全", "国", "胜", "学", "祥", "才 发", "武", "新", "利", "清", "飞", "彬",
            "富", "顺", "信", "子", "杰", "涛", "昌", "成", "康", "星", "光", "天", "达", "安", "岩", "中", "茂", "进", "林有", "坚", "和", "彪", "博", "诚", "先", "敬", "震", "振", "壮", "会", "思 群",
            "豪", "心", "邦", "承", "乐", "绍", "功", "松", "善", "厚", "庆", "磊民", "友", "裕", "河", "哲", "江", "超", "浩", "亮", "政", "谦", "亨", "奇 固", "之", "轮", "翰", "朗", "伯", "宏", "言",
